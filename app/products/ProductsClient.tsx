...
export default function ProductsClient({ categories, platforms }: Props) {
        ...
        {platforms.length > 0 && (
          <div className="relative">
            <select value={platform} onChange={e => setPlatform(e.target.value)}
              className="pl-3 pr-3 py-2 border rounded-lg text-sm appearance-none focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white">
